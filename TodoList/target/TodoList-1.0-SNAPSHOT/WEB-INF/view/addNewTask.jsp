...
<html>
    <head>
        ...
        <link href="static/css/addNewTask.css?version=51" rel="stylesheet" type="text/css"/>
    </head>
    <body>
        <div>
        ...
        <div class="todo_form">
            ...
            <div class="heading"><p><h3>Create new Task</h3></P></div>
                ...
                <div class="title">
                    ...
                    <f:input path="title" placeholder="What task do you want to assign?" id="title"/>
                </div>
                </br>
                </br>

                <div class="textarea">
                    <p><h3>Who do you assign the task to?</h3></p>
                    <f:textarea path="description" placeholder="Eg. Mom, Dad, Son, Sister" id="textarea"/>
                </div>
                </br>
                ...
                <div class="status">
                    <p><h3>Select the status of Your Task</h3></p>
                </div>
                <div class="radio">
                ...
                <div class="radio">
                    ...
                    <label for="low">(-) Not Completed</label>
                </div>
                <div class="button">
