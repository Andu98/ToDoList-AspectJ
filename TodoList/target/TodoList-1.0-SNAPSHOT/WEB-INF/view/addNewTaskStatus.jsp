...
Enter the task deadline</p>
                ...
                <div class="title">
                    ...
                    <f:input path="title" placeholder="Give a title to your task" id="title"/>
                </div>
                </br>
                </br>

                <div class="textarea">
                    <p><h3>Assigned to:</h3></p>
                    <f:textarea path="description" placeholder="Assigned to:" id="textarea"/>
                </div>
                </br>
                </br>
                <div class="status">
                    <p><h3>Select status of this Task</h3></p>
                </div>
                <div class="radio">
